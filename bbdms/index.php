...
<?php include('includes/slider.php');?>
    ...
    <div class="container">
        ...
        <h1 class="my-4">Welcome to lifeline BloodBank</h1>
            ...
            <div class="col-lg-4 mb-4">
                <div class="card">
                    <h4 class="card-header">Who you could Help </h4>
                        ...
                        <p class="card-text" style="padding-left:2%">Your blood saves lives. Your blood donation is an amazing gift to people who need it in an emergency or for on-going medical treatment.Every day, blood donors help patients of all ages: accident and burn victims, heart surgery and organ transplant patients, and those battling cancer. </p>
                </div>
            </div>
            <div class="col-lg-4 mb-4">
                <div class="card">
                    <h4 class="card-header">Blood Facts in General</h4>
                   
                        <p class="card-text" style="padding-left:2%">There is no substitute for human Blood
Blood makes up about 7% of your body's weight.
An average adult has about 14 to 18 pints of Blood.
One standard unit or pint of Blood equals about two cups.
Blood carries oxygen and nutrients to all of the body. </p>
                </div>
            </div>
        </div>
        <!-- /.row -->
